...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/zhucaidan/doubi/master/ss-go.sh && chmod +x ss-go.sh && bash ss-go.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/zhucaidan/doubi/master/mtproxy_go.sh && chmod +x mtproxy_go.sh && bash mtproxy_go.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/zhucaidan/doubi/master/ban_iptables.sh && chmod +x ban_iptables.sh && bash ban_iptables.sh
```
